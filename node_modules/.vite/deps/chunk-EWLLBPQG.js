...
// node_modules/canvas-core-tokens/lib/index.js
var require_lib = __commonJS({
  "node_modules/canvas-core-tokens/lib/index.js"(exports, module) {
    !function(e2, r2) {
      "object" == typeof exports && "object" == typeof module ? module.exports = r2() : "function" == typeof define && define.amd ? define("canvas-core-tokens", [], r2) : "object" == typeof exports ? exports["canvas-core-tokens"] = r2() : e2["canvas-core-tokens"] = r2();
      ...
      return function(e2) {
        ...
        function a2(o2) {
          ...
          var t2 = r2[o2] = { i: o2, l: false, exports: {} };
          return e2[o2].call(t2.exports, t2, t2.exports, a2), t2.l = true, t2.exports;
        }
        return a2.m = e2, a2.c = r2, a2.d = function(e3, r3, o2) {
          a2.o(e3, r3) || Object.defineProperty(e3, r3, { enumerable: true, get: o2 });
        }, a2.r = function(e3) {
          "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e3, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e3, "__esModule", { value: true });
        }, a2.t = function(e3, r3) {
          if (1 & r3 && (e3 = a2(e3)), 8 & r3)
            return e3;
          if (4 & r3 && "object" == typeof e3 && e3 && e3.__esModule)
            return e3;
          var o2 = /* @__PURE__ */ Object.create(null);
          if (a2.r(o2), Object.defineProperty(o2, "default", { enumerable: true, value: e3 }), 2 & r3 && "string" != typeof e3)
            for (var t2 in e3)
              a2.d(o2, t2, function(r4) {
                return e3[r4];
              }.bind(null, t2));
          return o2;
        }, a2.n = function(e3) {
        ...
        var g2 = { light: { color: p({}, u2), gray: p({}, d2) }, dark: { color: p({}, b2), gray: p({}, i2) } }, m = { borderRadius: { 0: "10rem", 50: "0.2rem", 100: "0.4rem", 200: "0.8rem", 300: "1.2rem" }, borderWidth: { 1: "0.1rem", 2: "0.2rem", 3: "0.3rem", 5: "0.5rem" }, breakPoints: { xs: "0px", sm: "375px", md: "768px", lg: "1024px" }, spacing: { 1: "0.6rem", 2: "1.2rem", 3: "1.8rem", 4: "2.4rem", 5: "3.0rem", 6: "3.6rem", 7: "4.2rem", 8: "4.8rem", 9: "5.4rem", 10: "6.0rem", 11: "6.6rem", 12: "7.2rem", 13: "7.8rem", 14: "8.4rem", 15: "9.0rem", 16: "9.6rem", 17: "10.2rem", 18: "10.8rem", 19: "11.4rem", 20: "12.0rem" }, sizing: { 24: "2.4rem", 32: "3.2rem", 36: "3.6rem", 42: "4.2rem", 44: "4.4rem", 48: "4.8rem", 54: "5.4rem", 60: "6.0rem", 72: "7.2rem" } }, F2 = { elevation: { 100: "0px 2px 10px rgba(0, 34, 91, 0.11)" }, motion: { 100: "200ms", 150: "350ms", 200: "500ms", 300: "0.1s", 400: "0.2s", 500: "0.3s", 600: "0.4s", 700: "0.5s", 800: "0.6s" }, opacity: { 0: 0, 2: 0.02, 3: 0.03, 5: 0.05, 11: 0.11, 15: 0.15, 16: 0.16, 38: 0.38, 50: 0.5, 60: 0.6, 87: 0.87, 100: 1 } }, f = function() {
          var e3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", r3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1;
          if (0 === e3.indexOf("rgb"))
            return e3;
          var a3 = e3.replace("#", "");
          3 === a3.length && (a3 = "".concat(a3[0]).concat(a3[0]).concat(a3[1]).concat(a3[1]).concat(a3[2]).concat(a3[2]));
          var o3 = parseInt(a3.substring(0, 2), 16), t3 = parseInt(a3.substring(2, 4), 16), n3 = parseInt(a3.substring(4, 6), 16);
          return r3 > 1 && r3 <= 100 && (r3 /= 100), "rgba(".concat(o3, ",").concat(t3, ",").concat(n3, ",").concat(r3, ")");
        }, k2 = { type: "light", primary: { main: u2.primaryRed, dark: u2.darkRed }, secondary: { main: u2.darkBlue, dark: u2.darkBlue100 }, background: { base: u2.base, primary: u2.base, secondary: u2.base, snackbar: i2.hex[800], skeleton: d2[550], overlay: i2[575], modal: u2.base, alertBanner: { info: f(u2.blue, 0.08), alert: f(u2.orange, 0.08), success: f(u2.green, 0.08), error: f(u2.brandRed, 0.08), new: f(u2.purple, 0.08) }, header: { red: u2.primaryRed, black: d2[700], white: d2[0] }, footer: { base: { grey: d2[200], white: d2[0] }, logo: { default: u2.primaryRed } }, navigation: { default: u2.base }, statusBadge: { default: "transparent", emphasis: "transparent", error: "transparent", new: u2.purple, "success-emphasis": "transparent", success: u2.green }, progressIndicator: { container: { default: d2[300] }, bar: { default: u2.green } }, comboBox: { default: u2.base, listBoxItem: { hover: d2[300] } }, meter: { incomplete: d2[300] }, table: { row: "rgba(226, 232, 238, 0.4)" } }, border: { default: d2[600], card: d2[400], pillButton: { default: d2[700], caution: u2.primaryRed }, skeleton: d2[550], alertBanner: { info: f(u2.blue, 0.5), alert: f(u2.orange, 0.5), success: f(u2.green, 0.5), error: f(u2.brandRed, 0.5), new: f(u2.purple, 0.5) }, header: { white: d2[400] }, statusBadge: { default: d2[600], emphasis: u2.darkBlue, error: u2.darkRed, new: u2.purple, "success-emphasis": u2.green, success: u2.green }, progressIndicator: { container: { default: d2[550] } }, meter: { default: d2[550] } }, text: { highEmphasis: d2[700], medEmphasis: d2[600], placeholder: d2[600], snackbar: { content: i2.hex[700], button: u2.blue }, secondaryButton: u2.primaryRed, pillButton: { default: d2[700], caution: u2.primaryRed, inverted: d2[700] }, statusBadge: { default: d2[600], emphasis: u2.darkBlue, error: u2.darkRed, new: d2[0], "success-emphasis": u2.green, success: d2[0] } }, action: { hover: { default: u2.darkBlue100, background: { pillButton: { default: d2[700], caution: u2.darkRed, inverted: d2[0] }, actionMenuList: { default: f(d2[400], 0.5) } }, text: { pillButton: { default: d2[0], caution: d2[0] }, snackbar: { button: b2.darkBlue100 } } }, focus: { default: u2.darkBlue, outline: u2.blue } }, state: { error: { default: u2.darkRed100 }, disabled: { border: d2[500], text: d2[550], background: d2[300] } }, icons: { functional: { red: u2.primaryRed, orange: u2.orange, green: u2.green, blue: u2.darkBlue, purple: u2.purple, pink: u2.pink, yellow: u2.yellow, black: u2.black, darkRed: u2.darkRed, darkBlue: u2.darkBlue, white: u2.base, gray: d2[550] } }, sidesheet: { overlay: { background: u2.base }, persistent: { background: u2.base } }, loadingIndicator: { red: u2.brandRed, darkGray: d2[550] } };
        function h2() {
          return (h2 = Object.assign || function(e3) {
            for (var r3 = 1; r3 < arguments.length; r3++) {
              var a3 = arguments[r3];
              for (var o3 in a3)
                Object.prototype.hasOwnProperty.call(a3, o3) && (e3[o3] = a3[o3]);
        ...
        var y2 = h2({}, k2, { primary: { main: u2.black, dark: u2.black }, secondary: { main: u2.black, dark: u2.black } }), E2 = { type: "dark", primary: { main: b2.primaryRed, dark: b2.darkRed }, secondary: { main: b2.darkBlue, dark: b2.darkBlue100 }, background: { base: b2.base, primary: i2[300], secondary: i2[800], snackbar: i2[0], skeleton: i2[300], overlay: i2[575], modal: d2[800], alertBanner: { info: f(b2.blue, 0.05), alert: f(b2.orange, 0.05), success: f(b2.green, 0.05), error: f(b2.brandRed, 0.05), new: f(b2.purple, 0.05) }, header: { red: i2.hex[800], black: i2.hex[800], white: b2.base }, footer: { base: { grey: i2[300], white: b2.base }, logo: { default: i2[700] } }, navigation: { default: i2.hex[300] }, statusBadge: { default: "transparent", emphasis: "transparent", error: "transparent", new: b2.purple, "success-emphasis": "transparent", success: b2.green }, progressIndicator: { container: { default: i2[800] }, bar: { default: b2.green } }, comboBox: { default: i2.hex[300], listBoxItem: { hover: i2[400] } }, meter: { incomplete: i2[800] }, table: { row: i2[100] } }, border: { default: i2.hex[600], card: i2[500], pillButton: { default: i2[0], caution: b2.primaryRed }, skeleton: i2[500], alertBanner: { info: f(b2.blue, 0.5), alert: f(b2.orange, 0.5), success: f(b2.green, 0.5), error: f(b2.brandRed, 0.5), new: f(b2.purple, 0.5) }, header: { white: i2[400] }, statusBadge: { default: i2[600], emphasis: b2.darkBlue, error: b2.darkRed100, new: b2.purple, "success-emphasis": b2.green, success: b2.green }, progressIndicator: { container: { default: i2[500] } }, meter: { default: i2[500] } }, text: { highEmphasis: i2[700], medEmphasis: i2[600], placeholder: i2[600], snackbar: { content: d2[700], button: u2.darkBlue }, secondaryButton: i2[700], pillButton: { default: b2.base, caution: i2[0], inverted: b2.base }, statusBadge: { default: i2[600], emphasis: b2.darkBlue, error: b2.darkRed100, new: b2.base, "success-emphasis": b2.green, success: b2.base } }, action: { hover: { default: b2.darkBlue100, background: { pillButton: { default: i2[0], caution: b2.darkRed, inverted: i2[0] }, actionMenuList: { default: i2[300] } }, text: { pillButton: { default: d2[700], caution: i2[0] }, snackbar: { button: u2.darkBlue100 } } }, focus: { default: b2.darkBlue, outline: b2.darkBlue } }, state: { error: { default: b2.darkRed100 }, disabled: { border: i2[500], text: i2[550], background: i2[300] } }, icons: { functional: { red: b2.brandRed, orange: b2.orange, green: b2.green, blue: b2.darkBlue, purple: b2.purple, pink: b2.pink, yellow: b2.yellow, black: i2[700], darkRed: b2.darkRed, darkBlue: u2.darkBlue, white: i2[0], gray: i2[700] } }, sidesheet: { overlay: { background: i2.hex[800] }, persistent: { background: b2.base } }, loadingIndicator: { red: u2.brandRed, darkGray: i2[700] } };
        function B2() {
          return (B2 = Object.assign || function(e3) {
            for (var r3 = 1; r3 < arguments.length; r3++) {
              var a3 = arguments[r3];
              for (var o3 in a3)
                Object.prototype.hasOwnProperty.call(a3, o3) && (e3[o3] = a3[o3]);
        ...
        var v2 = { itrade: { light: y2, dark: B2({}, E2, { primary: { main: b2.black, dark: b2.black }, secondary: { main: b2.black, dark: b2.black } }) }, default: { light: k2, dark: E2 } };
        function C2() {
          return (C2 = Object.assign || function(e3) {
            for (var r3 = 1; r3 < arguments.length; r3++) {
              var a3 = arguments[r3];
              for (var o3 in a3)
                Object.prototype.hasOwnProperty.call(a3, o3) && (e3[o3] = a3[o3]);
        ...
        function x2() {
          return (x2 = Object.assign || function(e3) {
            for (var r3 = 1; r3 < arguments.length; r3++) {
              var a3 = arguments[r3];
              for (var o3 in a3)
                Object.prototype.hasOwnProperty.call(a3, o3) && (e3[o3] = a3[o3]);
        ...
        var D2 = { itrade: "itrade", default: "default" }, w2 = { light: "light", dark: "dark", default: "light" }, R2 = function(e3) {
          var r3 = e3 || {}, a3 = r3.mode, o3 = r3.theme, t3 = a3 || w2.default, n3 = o3 || D2.default;
          return t3 && !w2[t3] && (t3 = w2.default), n3 && !D2[n3] && (n3 = D2.default), function(e4) {
            var r4 = e4.mode, a4 = e4.theme;
            return C2({ typography: c2, palette: g2[r4], size: m, transform: F2 }, function(e5) {
              return v2[e5.theme][e5.mode];
            }({ mode: r4, theme: a4 }));
          }({ mode: t3, theme: n3 });
        }, A2 = function(e3) {
          return x2({}, o2, { dark: t2 }[e3], { brandColors: { light: { red: "#ec111a", orange: "#fb6330", green: "#138468", blue: "#009dd6", purple: "#7849b8", pink: "#f2609e", yellow: "#ffd42f", black: "#333333", darkRed: "#BE061B", darkBlue: "#007EAB", white: "#FFFFFF" }, dark: { red: "#ff969c", orange: "#ffba8e", green: "#84d9c6", blue: "#91ddf8", purple: "#aea9f4", pink: "#fda8de", yellow: "#ffeaa5", black: "#757575", white: "#333333" } }, canvasGrey: { 100: "#FAFBFD", 200: "#F6F7FC", 300: "#F6F6F6", 400: "#E2E8EE", 500: "#D6D6D6", 600: "#757575", 700: "#949494" }, canvasShadow: "rgba(0, 34, 91, 0.11)", common: { white: "#FFFFFF", black: "#333333" } });
        }, O2 = { spacing1: 0.6, spacing2: 1.2, spacing3: 1.8, spacing4: 2.4, spacing5: 3, spacing6: 3.6, spacing7: 4.2, spacing8: 4.8, spacing9: 5.4, spacing10: 6, spacing11: 6.6, spacing12: 7.2, spacing13: 7.8, spacing14: 8.4, spacing15: 9, spacing16: 9.6, spacing17: 10.2, spacing18: 10.8, spacing19: 11.4, spacing20: 12 }, S2 = { gridColumns: 12, containerMaxWidth: 1200, containerMaxWidthMargins: 1272, containerMinWidth: 320, breakPoints: { xs: { size: "xs", minWidth: "0px", maxWidth: "480px", gutter: 1.8, margin: ["1.8rem", "2.4rem", "3.0rem", "3.6rem"], rowMargin: "-0.6rem", maxCols: 4 }, sm: { size: "sm", minWidth: "481px", maxWidth: "767px", gutter: 1.8, margin: ["2.4rem", "3.0rem", "3.6rem", "4.2rem"], rowMargin: "-1.2rem", maxCols: 8 }, md: { size: "md", minWidth: "768px", maxWidth: "1024px", gutter: 3, margin: ["3.6rem", "4.2rem", "4.8rem", "5.4rem"], rowMargin: "-1.5rem", maxCols: 12 }, lg: { size: "lg", minWidth: "1025px", maxWidth: "4000px", gutter: 3, margin: "3.6rem", rowMargin: "-1.8rem", maxCols: 12 } } };
        r2.default = function(e3) {
          var r3 = '"Arial", "Helvetica", "sans-serif"', a3 = { fontLightFamily: '"Scotia Light", '.concat(r3), fontRegularFamily: '"Scotia Regular", '.concat(r3), fontBoldFamily: '"Scotia Bold", '.concat(r3), fontHeadlineFamily: '"Scotia Headline", '.concat(r3), fontItalicFamily: '"Scotia Italic", '.concat(r3), fontBoldItalicFamily: '"Scotia Bold Italic", '.concat(r3) };
          return { type: e3 || "light", breakPoints: { values: { lg: 1025, md: 768, sm: 481, xs: 0 } }, palette: A2(e3), transitions: { duaration: { sideSheetMainWrapper: "600ms" }, effect: { easing: { easeInOut: "ease-in-out" } } }, typography: a3, tokens: R2({ mode: e3 }) };
        };
      }]);
    });
  }
 ...
 */
//# sourceMappingURL=chunk-EWLLBPQG.js.map
